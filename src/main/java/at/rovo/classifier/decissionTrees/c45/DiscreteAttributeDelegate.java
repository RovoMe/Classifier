 ...
 * @author Ping He
 * @author Xiaohua Xu
 * @see ContinuousAttributeDelegate
...
public class DiscreteAttributeDelegate extends AttributeDelegate
{
    ...
    public float[] evaluate(int first, int last, AttributeDelegate classAttributeDelegate)
    {
        ...
        // This variable records the weight distribution of the [first last) cases in different branches of the current
        // attribute
        float[] branchDistri = new float[branchCount + 1];
        // This variable records the weight distribution of the [first last) cases in different classes of the different
        // branches of the attribute
        ...
        // If there is too much missing data on this attribute, return nothing to try the next attribute
        ...
        /*
         * Compute the entropy of the tree node as a Leaf Then compute the gain and splitInfo of the tree node as an
        ...
        // The last two -1 are filled for the consistency output with ContinuousAttributeDelegate's evaluate, it means
        // there are no valid split ranks for discrete attribute
