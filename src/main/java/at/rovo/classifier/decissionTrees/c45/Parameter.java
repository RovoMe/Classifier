...
public class Parameter
{
     ...
     * <p>
     * CONFIDENCE must be changed together with SQUAREDSTD parameter. The setConfidence(float confidence) method in
     * ml.classifier.dt.Estimator can be used to reset confidence and its corresponding SQUAREDSTD.
     */
     ...
     * <p/>
     * SQUAREDSTD must be changed together with CONFIDENCE parameter. The setConfidence(float confidence) method in
     * ml.classifier.dt.Estimator can be used to reset confidence and its corresponding SQUAREDSTD.
     */
