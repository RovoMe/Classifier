...
public abstract class AttributeDelegate
{
     ...
     *
     * @see at.rovo.classifier.decissionTrees.c45.GainCalculator
     */
     ...
     * <p/>
     * When an attribute is selected as the test attribute, missing value is not taken as a valid branch value.
     */
     ...
     * <p/>
     * Only supported by discrete attribute delegates and used by class attribute delegate.
     *
     * @param caseIndex
     ...
     *
     * @see at.rovo.classifier.decissionTrees.c45.DiscreteAttributeDelegate#getClassBranch(int caseIndex)
     */
     ...
     *
     * @see at.rovo.classifier.decissionTrees.c45.ContinuousAttributeDelegate#findCutRank(int splitRank, int
     * preSplitRank)
     */
