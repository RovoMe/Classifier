...
public abstract class TreeNode
{
	 ...
	 * <p>
	 * Only root has a specified name of the tree.
	 * </p> 
	 **/
	 ...
	 * 
	 * @param content Sets the new content of this instance
	 */
	 ...
	 * 
	 * @param aChild A new child of this instance
	 */
	 ...
	 * 
	 * @param children The new children of this instance
	 */
	 ...
	 * 
	 * @param index The position to add the new child at
	 * @param child The new child to add at the index<sup>th</sup> position
	 */
	 ...
	 * 
	 * @return If there is no missing data distributed on the tree node, the
	 *         train error should be an integer; <br>
	 *         Otherwise, the train error should be an estimated <i>float</i>
	 *         value computed by some statistical method.
	 * 
	 ...
	 * 
	 * @param error The new train error
