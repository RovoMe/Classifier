...
public class TreeViewAdapter implements TreeView
{
     ...
     *
     * @param line
     *         The line to insert at the start of the body
     */
    @Override
     ...
     *
     * @param line
     *         The line to append to the body of this instance
     */
    @Override
    ...
    /**
     * Appends the body of <em>treeView</em> to the end of the body of this instance.
     * <p>
     * If <em>treeView</em> is not of the same type as the current instance a {@link UnsupportedOperationException} will
     * be thrown.
     *
     * @param treeView
     *         The element whose body should be appended to the body of the current instance
     */
    @Override
