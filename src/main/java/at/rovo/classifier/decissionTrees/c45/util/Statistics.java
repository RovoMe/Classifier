...
public class Statistics
{
    ...
    /**
     * Compute the standard deviation of the specified float array. <br> An alternative method of
     * <em>standardDeviation</em>()
     *
     * @param list
     *         The float array whose standard deviation is to be computed
     *
    ...
    /**
     * Quick sort the specified values in <i>data</i> array and adjust their corresponding values in <i>id</i> array.
     * <p>
     * It is called when the number of values to be sorted is greater than the THRESHOLD value.
     *
     * @param data
    ...
    /**
     * Insert sort the specified values in <i>data</i> array and adjust their corresponding values in <i>id</i> array.
     * <p>
     * It is called when the number of values to be sorted is equal or less than the THRESHOLD value.
     *
     * @param data
     *         The float array to be sorted
     * @param id
    ...
    /**
     * Find the median of data[left], data[right] and data[center] three values and range them in order.
     *
     * @param data
     *         The float array to be sorted
     * @param id
