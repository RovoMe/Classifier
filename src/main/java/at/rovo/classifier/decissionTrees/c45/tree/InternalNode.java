 ...
 * <p>
 * An internal node is a super set of a tree node. <br> It not only contains a basic tree node content, it also contains
 * some information about its test attribute.
 *
 * @author Ping He
 * @author Xiaohua Xu
 */
public class InternalNode extends TreeNode
{
    ...
    private float cut;
    /**
     * The rank of the cut value among all the attribute values of the train data on the test attribute. This is used
     * for the speedup of C45 algorithm.
     **/
    private int cutRank;
