...
public class CrossValidator
{
     ...
     * distributed data can be produced. Then a classifier is built on the train data in each fold, followed with the
     * test data classified using the classifier to get its test error ratio.
     *
     * @param dataSet
