...
public class C45
{
	...
	/**
	 * Build a decision tree with the specified .names and .data files, prune it
	 * and print it in the specified manner.
	 */
	public static void main(String[] args)
	{
		...
		if (!output.equals("plain") && !output.equals("html")
				&& !output.equals("xml"))
		{
	...
	private static TreeView xmlView(DecisionTree tree, String buildTime)
	{
		...
		v1.append(prefix2 + "<trainerror>" + tree.getTrainError()
				+ "</trainerror>");
		if (!buildTime.equals(""))
		{
		...
		v2.append(prefix2 + "<trainerror>" + tree.getTrainError()
				+ "</trainerror>");
	...
	{
		System.out.println("Usage: java " + C45.class
				+ " dataSetName [-output plain | html | xml  -repeat times]");
