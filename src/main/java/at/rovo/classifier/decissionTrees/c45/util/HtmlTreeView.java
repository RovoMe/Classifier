...
public class HtmlTreeView extends TreeViewAdapter
{
    ...
    public void initBody()
    {
        ...
        buffer.append(TreeView.LEVEL_GAP).append(TreeView.LEVEL_GAP)
                .append("dt" + count + " = new dTree('dt" + count + "');").append(TreeView.CR);
        ...
        {
            buffer.append(TreeView.LEVEL_GAP).append(TreeView.LEVEL_GAP).append("dt" + count + ".add(")
        ...
        buffer.append(TreeView.LEVEL_GAP).append(TreeView.LEVEL_GAP).append("document.write(dt" + count + ")")
                .append(TreeView.CR);
        buffer.append(TreeView.LEVEL_GAP).append(TreeView.LEVEL_GAP).append("dt" + count + ".openAll()")
                .append(TreeView.CR);
