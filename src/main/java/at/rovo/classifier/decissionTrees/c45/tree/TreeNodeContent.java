...
public class TreeNodeContent
{
	 ...
	 * 
	 * @param trainWeight The total weight of the data distributed on the tree 
	 *                    node
	 * @param trainClassDistribution The class distribution of the data 
	 *                               distributed on the tree node
	 * @param classification The classification of the tree node
	 * @param errorAsLeafNode The classification error of the tree node as a 
	 *                        leaf node
	 */
	public TreeNodeContent(float trainWeight, float[] trainClassDistribution,
			String classification, float errorAsLeafNode)
	{
	 ...
	 * 
	 * @param minKnownWeight The minimal known weight
	 */
