 ...
 * Example:
 * <p>
 * <code> categories: ['in','out']<br/> catCount: [1,1]<br/> wordVector: {word1:pos1,word2:po2,word3:pos3}<br/>
 * occurrences: [[num00,num01,0],[num10,0,num12]] </code>
 * <p>
 * The example above contains two sample sentences. The first sentence contains <em>word1</em> num00 times and
 * <em>word2</em> num01 times while sentence two contains <em>word1</em> num10 times and <em>word3</em> num12 times.
 * <p>
