...
public enum TrainingDataStorageMethod
{
     ...
     * 'out':{'word1':num3,'word3':num4}}</code> where <em>in</em> and <em>out</em> are the classes and <em>word1<em>
     * till <em>word3</em> are features and <em>num1</em> till <em>num4</em> are the occurrences of the respective
     * feature in all training examples for the respective trained class.
     */
    MAP,
