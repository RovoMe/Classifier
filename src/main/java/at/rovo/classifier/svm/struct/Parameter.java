...
public class Parameter implements Cloneable, java.io.Serializable
{
    ...
    /**
     * Specifies how many outliers are taken into account. It therefore specifies the importance of outliers in respect
     * to the margin.
     * <p>
     * The larger C is the less the final training error will be. But on increasing C too much one risks losing the
     * generalization properties of the classifier, because it will try to fit as best as possible all the training
     * points (including the possible errors of the dataset).
     * <p>
    ...
    /**
     * Measured the cost of the errors on the training points. These are zero for all points that are inside the
