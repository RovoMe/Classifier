...
public class NormalNaiveBayesTest extends NormalNaiveBayes<String, String>
{
    ...
    public void testProbability()
    {
        ...
        Assert.assertEquals("nb-P('bad'|'quick') ", 1. / 3, p,
                            0.00005); // rounding-difference - result is: 0.33333333333333337
        ...
        Assert.assertEquals("Testing the sum of probability and complementary probability", 1., prob1 + prob2,
                            0.00000000003);
    }
